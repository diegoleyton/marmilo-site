...
Android testing requests create a separate `Android Requests` tab containing only the request time, Google Play email, requested product, language, and page URL. This tab is an inbox of pending requests, not a mirror of the Google Play tester list and does not represent approval status.
